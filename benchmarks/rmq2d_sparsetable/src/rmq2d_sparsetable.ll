...
; Function Attrs: nounwind ssp uwtable
define dso_local i32 @min(i32 %x, i32 %y) #0 {
entry:
...
; Function Attrs: nounwind ssp uwtable
define dso_local i32 @count_leading_zeros(i32 %x) #0 {
entry:
  br label %for.cond
...
; Function Attrs: nounwind ssp uwtable
define dso_local i32 @floorlog2(i32 %x) #0 {
entry:
...
; Function Attrs: nounwind ssp uwtable
define dso_local i32* @input(i32 %i, i32 %j) #0 {
entry:
...
; Function Attrs: nounwind ssp uwtable
define dso_local i32 @width(i32 %j) #0 {
entry:
...
; Function Attrs: nounwind ssp uwtable
define dso_local i32 @height(i32 %i) #0 {
entry:
...
; Function Attrs: nounwind ssp uwtable
define dso_local i32** @A(i32 %i, i32 %j) #0 {
entry:
...
; Function Attrs: nounwind ssp uwtable
define dso_local i32 @P(i32 %i, i32 %j, i32 %ii, i32 %jj) #0 {
entry:
