...
; CHECK: .entry:
; CHECK-NEXT: [[REG4:r[0-9]+]] = add arg1 arg2 32
; CHECK-NEXT: [[REG1:r[0-9]+]] = mul arg1 1 32
; CHECK-NEXT: [[REG3:r[0-9]+]] = mul arg1 1 32
; CHECK-NEXT: br .for.header
; CHECK: .for.header:
; CHECK-NEXT: [[REG2:r[0-9]+]] = icmp eq [[REG3]] [[REG4]] 32
; CHECK-NEXT: [[REG5:r[0-9]+]] = mul [[REG1]] 1 32
; CHECK-NEXT: [[REG1]] = mul [[REG3]] 1 32
; CHECK-NEXT: [[REG3]] = mul [[REG5]] 1 32
